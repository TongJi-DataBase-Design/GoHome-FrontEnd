...
<div>
  <el-card shadow="hover" style="width:95%;margin:0 auto;border-radius:15px;margin-top:10px">
    ...
    <div v-for="cnt of 3" :key="cnt">
      <div style="margin:5px 0 5px 0" v-if="cnt===1">
...
<!--        <div v-for="near of "></div>-->
      <div style="margin:5px 0 5px 0" v-else-if="cnt===2">
      ...
      <div style="margin:5px 0 5px 0" v-else>
        <i class="iconfont icon-huochezhan3" id="myIcon"></i>
          <span class="myInfo">机场/火车站</span>
      <span class="myVal" v-for="n of airpotNearby" :key="n">{{n.nearbyName}}({{n.nearbyDistance}}) &nbsp; </span></div>
    </div>
    <div>
      <h1>这里是地图</h1>
    </div>
